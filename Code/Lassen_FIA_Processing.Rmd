...
FIA.sf <- FIA %>%
  ...
  st_set_crs(., st_crs("EPSG:4269")) #ABCHECKME I'm getting an error message here: "invalid crs: EPSG:4269, reason: no arguments in initialization list"
...
#Start with 294 plots (FIA plots within boundary).
#Extracting DEM values to FIA plots.
#Converting elevation of FIA plots (originally in feet) to meters.
#Selecting FIA plots within the elevation range of the QQ data (1113m - 2126m; removed 61 plots).
#Selecting plots within "fuzzing" standards (150 m max discrepancy; removed 30 plots).
#End with 203 plots.
...
#Remove plots with more than 1 condition (81 plots removed; 122 plots remain).
#Remove plots with fire damage (31 plots removed; 91 plots remain).
#Removed plots where FORTYPCD = 999 (1 plot with stand age = 0 (seedlings only), 90 plots remain).
#End with 90 plots.
...
#Removed California black oak (n = 4), canyon live oak (n = 2), tanoak (n = 1), and mountain hemlock (n = 1)
#End with 82 plots.
...
#None of the plots contained 100% hardwoods, 82 plots still remain.
...
#Removed plots where live BA < 9 m^2/ha (6 plots removed; 76 plots remain).
...
#Removing plots without Abies or Pinus spp (0 plots removed, 76 plots remain).
#End with 76 plots.
