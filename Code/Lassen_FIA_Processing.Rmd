...
#EPSG 4269, NAD83.
#ABCHECKME: The directory below, USFS_boundaries, exists within the GIS directory. 
  #However there is no ".shp" file, only the external files.
  #I think you tried to move it to large_files but something got messed up.
  #It's not a large file and it should exist within "GIS" so I moved it back and updated below.
  #Same thing with county boundaries. -JTS
...
#ABCHECKME similar file path issue here; DEM_mask.img is now in large_files.
  #You had it in GIS/Files_from_R -JTS
#Loading clipped DEM data.
DEM <- raster(here("large_files", "DEM_mask.img"))
