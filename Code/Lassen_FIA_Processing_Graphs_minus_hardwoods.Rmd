...
FIA_graphs <- read.csv(here("Data/Derived", "d_FIA_minus_hardwoods.csv"))
...
ggplot(FIA_BA, aes(BALIVE_sqmha)) + 
  ...
  ylab("Count") + 
  ggsave(here("Figures/Lassen-Plumas", "BALive_minus_hw.png"),
...
ggplot(Private_BA, aes(BALIVE_sqmha)) + 
  ...
  xlab(bquote("Live BA"~(m^2~ha^-1))) +
  ylab("Count") + 
  ggsave(here("Figures/Lassen-Plumas", "BALive_ownership_minus_hw.png"),
         width = 6, height = 4, dpi = 500)
...
ggplot(FIA_BA, aes(BALIVE_sqmha, fill = ownership)) + 
  ...
  ggsave(here("Figures/Lassen-Plumas", "BALive_density_ownership_minus_hw.png"),
         width = 6, height = 4, dpi = 500)
...
ggplot(FIA_BA, aes(AB_PI)) + 
  ...
  xlab("Fir-Pine Ratio") +
  ylab("Count") + 
  ggsave(here("Figures/Lassen-Plumas", "Fir_Pine_minus_hw.png"),
         width = 6, height = 4, dpi = 500)  
...
ggplot(Private_BA, aes(AB_PI)) + 
  ...
  xlab("Fir-Pine Ratio") +
  ylab("Count") + 
  ggsave(here("Figures/Lassen-Plumas", "Fir_Pine_ownership_minus_hw.png"),
         width = 6, height = 4, dpi = 500)
...
ggplot(FIA_BA, aes(AB_PI, fill = ownership)) + 
  ...
  ylab("Density") +
  theme(legend.title = element_blank()) +
  ggsave(here("Figures/Lassen-Plumas", "Fir_Pine_density_ownership_minus_hw.png"),
         width = 6, height = 4, dpi = 500)
...
ggplot(FIA_density, aes(TPH)) +
  ...
  ylab("Count") + 
  ggsave(here("Figures/Lassen-Plumas", "TPH_minus_hw.png"),
         width = 6, height = 4, dpi = 500)
...
ggplot(Private_density, aes(TPH)) +
  ...
  geom_histogram(data = Federal_density, aes(TPH),
                 ...
                 linetype = "dashed") + 
  ylab("Count") + 
  ggsave(here("Figures/Lassen-Plumas", "TPH_ownership_minus_hw.png"),
         width = 6, height = 4, dpi = 500)
...
ggplot(FIA_density, aes(TPH, fill = ownership)) + 
  ...
  facet_wrap(~dbh, scales = "free") +
  theme(legend.title = element_blank()) +
  ggsave(here("Figures/Lassen-Plumas", "TPH_density_ownership_minus_hw.png"),
         width = 6, height = 4, dpi = 500)
